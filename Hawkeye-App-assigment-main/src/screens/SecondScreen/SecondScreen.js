  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.two}>
        <Text style={styles.text2}>Customize your </Text>
        <Text style={styles.text3}> High-end travel</Text>
        <Text style={styles.text4}>Countless high-end {'\n'} entertainment facilities</Text>
